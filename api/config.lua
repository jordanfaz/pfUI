...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("appearance", "bags",        "hidegold",         "0")
  pfUI:UpdateConfig("appearance", "bags",        "showbind",         "1")
  ...
  for _, unit in pairs(ufs) do
    ...
    pfUI:UpdateConfig("unitframes", unit,      "portraitoffx",     "0")
    pfUI:UpdateConfig("unitframes", unit,      "portraitoffy",     "0")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "buffoffx",         "0")
    pfUI:UpdateConfig("unitframes", unit,      "buffoffy",         "0")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "debuffoffx",       "0")
    pfUI:UpdateConfig("unitframes", unit,      "debuffoffy",       "0")
  ...
  pfUI:UpdateConfig("bars",       nil,           "custombgcolor",    "0")
  pfUI:UpdateConfig("bars",       nil,           "background_color", "0,0,0,.8")
  ...
  pfUI:UpdateConfig("castbar",    "player",      "hidetotaltimer",   "0")
  ...
  pfUI:UpdateConfig("castbar",    "target",      "hidetotaltimer",   "0")
  ...
  pfUI:UpdateConfig("castbar",    "focus",       "hidetotaltimer",   "0")
  ...
  pfUI:UpdateConfig("nameplates", nil,           "targetsymbols",    "off")
  pfUI:UpdateConfig("nameplates", nil,           "targetsymbolsize", "4")
  pfUI:UpdateConfig("nameplates", nil,           "targetsymbolgap",  "4")
  pfUI:UpdateConfig("nameplates", nil,           "targetsymbolcolor","1,1,1,1")
  ...
  pfUI:UpdateConfig("thirdparty", "combatledger", "dock",            "0")
