  ...
  do -- Generate Config UI
    CreateGUIEntry(T["About"], nil, function()
      ...
      github:SetScript("OnClick", function()
        pfUI.chat.urlcopy.CopyText(GetAddOnMetadata(pfUI.name, "X-Website") or "")
      end)
      SkinButton(github)
    ...
    CreateGUIEntry(T["Settings"], T["Appearance"], function()
      ...
      CreateConfig(U["bars"], T["Custom Action Bar Background"], C.bars, "custombgcolor", "checkbox")
      CreateConfig(U["bars"], T["Action Bar Background Color"], C.bars, "background_color", "color")
      ...
      CreateConfig(nil) -- spacer
      CreateConfig(nil, T["Force Blizzard Borders"], C.appearance.border, "force_blizz", "checkbox")
    ...
    CreateGUIEntry(T["Minimap"], T["Minimap"], function()
      CreateConfig(U["minimap"], T["Minimap Size"], C.appearance.minimap, "size")
    ...
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(U["nameplates"], T["Vertical Offset"], C.nameplates, "vertical_offset", nil, nil, nil, nil, nil)
      ...
      CreateConfig(U["nameplates"], T["Target Nameplate Symbol Gap"], C.nameplates, "targetsymbolgap", "dropdown", pfUI.gui.dropdowns.np_targetsymbolgap)
      CreateConfig(U["nameplates"], T["Target Nameplate Symbol Color"], C.nameplates, "targetsymbolcolor", "color")
    ...
    CreateGUIEntry(T["Thirdparty"], T["Integrations"], function()
      ...
      CreateConfig(nil, "CombatLedger (" .. T["Dock"] .. ")", C.thirdparty.combatledger, "dock", "checkbox")
      ...
      CreateConfig(nil, "TW/OW Threatmeter (" .. T["Skin"] .. ")", C.thirdparty.twt, "skin", "checkbox")
      CreateConfig(nil, "TW/OW Threatmeter (" .. T["Dock"] .. ")", C.thirdparty.twt, "dock", "checkbox")
